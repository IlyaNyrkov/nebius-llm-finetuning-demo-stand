...
if __name__ == "__main__":
    ...
    print("Step 2: Loading Model and Tokenizer (QLoRA)...")
    ...
    print("Step 3: Initializing SFTTrainer...")
    ...
    for root, _, files in os.walk(LOCAL_OUTPUT_DIR):
        for file in files:
            ...
            s3_key = os.path.join(S3_PREFIX, os.path.relpath(local_path, LOCAL_OUTPUT_DIR))
